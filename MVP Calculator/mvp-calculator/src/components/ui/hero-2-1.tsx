      ...
      <div className="relative z-10">
        ...
        <nav className="container mx-auto flex items-center justify-between px-4 py-4 mt-6">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-xl font-bold text-white">Mati Studios</span>
          </div>
        ...
        <div className="container mx-auto mt-12 px-4 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-300">
            Get accurate cost estimates and timeline planning for your Minimum Viable Product. 
            Built by founders, for founders. No technical jargon, just clear numbers.
          </p>
          ...
          <div className="relative mx-auto my-20 w-full max-w-6xl">
            ...
            {/* Hero Image - Updated for MVP Calculator */}
            <img
              src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2015&q=80"
              alt="MVP Calculator Dashboard"
